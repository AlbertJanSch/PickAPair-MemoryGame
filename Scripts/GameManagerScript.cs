...
public class GameManagerScript : MonoBehaviour
{
    ...
    // Integers that will be used for matchtimer (and new feature for sprint 3 of the game)
    ...
    void Update()
    {
        ...
        // Creates Match Timer and opens 
        if (_countdownTime.IsRunning)
            triesRemainingText.text = "Time Remaining: " + (int)(_timeRemaining - _countdownTime.Elapsed.TotalSeconds);
    ...
    void CardComparison(List<int> c)
    {
        ...
        {
            //_triesRemaining--;
            //triesRemainingText.text = "Tries Remaining: " + _triesRemaining;
